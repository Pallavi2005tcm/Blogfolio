...
const Footer = () => {
  return (
    <div className='px-6 md:px-16 lg:px:24 xl:px-32 bg-primary/3'>
      ...
      and ensures content quality through admin approval workflows. </p>
        ...
        <div className='flex flex-wrap justify-between w-full md:w-[45%] gap-5'>
           {footer_data.map((section,index)=>(
              <div key={index}>
                <h3 font-semibold text-base text-gray-900 md:mb-5 mb-2>{section.title}</h3>
                <ul>
      ...
      <p className='py-4 text-center text-sm md:text-base text-gray-500'>Copyright 2026 @ QuickBlog - All Right Reserved</p>
    </div>
  )
}
